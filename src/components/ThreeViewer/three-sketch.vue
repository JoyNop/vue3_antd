 ...
 * @Date: 2021-05-06 09:26:18
 * @LastEditors: HanRui(JoyNop)
 * @LastEditTime: 2021-05-06 09:29:34
 * @Description: file content
 * @FilePath: /lemon-tree/src/components/LemonViewer/three-sketch.vue
-->
<script lang="ts">
  ...
  setup(props) {
    ...
    onMounted(() => {
      ...
      if (containerElement instanceof HTMLElement) {
        const { init, animate } = props.src(containerElement)
